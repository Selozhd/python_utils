...
from python_utils.plot_utils import plot_roc_curve


def get_classification_report(y_true, y_scores, threshold):
...
class ClassificationReport(NamedTuple):
    ...
    def plot_roc_curve(self, save=None):
        ...
        return plot_roc_curve(fpr, tpr, self.auc, save=save)
